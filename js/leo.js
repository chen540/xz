 SPA_RESOLVE_INIT = function(transition) {
    ...
    JSONP.src = "http://interface.sina.cn/ast/get_mail_fate.d.json?astro=Leo&callback=Get_Constellation";
    JSONP.id = "pageid"
            ...
            <article class="fate-box Leo-fate-bg">\
                <section class="content-box">\
                    ...
                    <section class="details">\
                        <a class="details-btn fl Leo-but-01-bg" href="">今日运势详情</a>\
                    </section>\
                </section>\
            </article>\
            <section class="but-box clearfix">\
                <a class="but fl Leo-but-01-bg" id="share-btn" onclick="show()">去晒运势</a>\

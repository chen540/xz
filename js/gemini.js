                ...
                <h1 class="constellation-box">\
                    <span>\
                        ...
                        <div class="constellation-title fl">\
                            <p class="constellation">' + data.gemini.constellation + '</p>\
                            <p class="date">' + data.gemini.today + '</p>\
                        </div>\
                    </span>\
                </h1>\
                <section class="fate-text">\
                    <h2 class="fate-name">今日运势</h2>\
                    <p class="fate-content">' + data.gemini.fate + '</p>\
                </section>\
                <section class="fate-text">\
                    <h2 class="fate-name">今日禁忌</h2>\
                    <p class="fate-content">去做：' + data.gemini.behoove + '</p>\
                    <p class="fate-content">别做：' + data.gemini.taboo + '</p>\
                </section>\
            </section>\
        </article>\

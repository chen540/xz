SPA_RESOLVE_INIT = function(transition) {
    ...
    JSONP.src = "http://interface.sina.cn/ast/get_mail_fate.d.json?astro=Scorpio&callback=Get_Constellation";
    JSONP.id = "pageid"
            ...
            <article class="fate-box Scorpio-fate-bg">\
                <section class="content-box">\
                    ...
                    <section class="details">\
                        <a class="details-btn fl Scorpio-but-01-bg" href="">今日运势详情</a>\
                    </section>\
                </section>\
            </article>\
